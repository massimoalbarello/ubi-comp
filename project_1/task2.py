...
estimated_altitude.append(pvlib.atmosphere.pres2alt(pressure1/100.0)+50)
...
estimated_altitude.append(pvlib.atmosphere.pres2alt(pressure2/100.0)+50)
...
estimated_altitude.append(pvlib.atmosphere.pres2alt(pressure4/100.0)+50)
...
estimated_altitude.append(pvlib.atmosphere.pres2alt(pressure_at_jfj/100.0)+50)
print("Jungfraujoch: \t pressure: {0:.3f} \t minutes: ---------- \t estimated alt: {1:.2f} m".format(pressure_at_jfj, estimated_altitude[3]))
estimated_altitude.append(pvlib.atmosphere.pres2alt(pressure_at_top/100.0)+50)
...
estimated_altitude.append(pvlib.atmosphere.pres2alt(pressure7/100.0)+50)
...
estimated_altitude.append(pvlib.atmosphere.pres2alt(pressure9/100.0)+50)
...
estimated_altitude.append(pvlib.atmosphere.pres2alt(pressure10/100.0)+50)
...
estimated_altitude.append(pvlib.atmosphere.pres2alt(pressure11/100.0)+50)
...
estimated_altitude.append(pvlib.atmosphere.pres2alt(pressure12/100.0)+50)
...
estimated_altitude.append(pvlib.atmosphere.pres2alt(pressure13/100.0)+50)
...
estimated_altitude.append(pvlib.atmosphere.pres2alt(pressure14/100.0)+50)
...
estimated_altitude.append(pvlib.atmosphere.pres2alt(pressure15/100.0)+50)
...
estimated_altitude.append(pvlib.atmosphere.pres2alt(pressure16/100.0)+50)
